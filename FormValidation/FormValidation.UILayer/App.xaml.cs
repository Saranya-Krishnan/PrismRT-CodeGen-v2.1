...
namespace FormValidation.UILayer
{
    /// <summary>
    ...
    sealed partial class App : MvvmAppBase
    {
        ...
        protected override void OnLaunchApplication(LaunchActivatedEventArgs args) {
            NavigationService.Navigate("StateList", null);
        }
        ...
        protected override void OnInitialize(IActivatedEventArgs args) {
            ...
            _container.RegisterType<IStateRepository, StateRepository>(new ContainerControlledLifetimeManager());


            // Register web service proxies
            _container.RegisterType<IPersonServiceProxy, PersonServiceProxy>(new ContainerControlledLifetimeManager());
            _container.RegisterType<IStateServiceProxy, StateServiceProxy>(new ContainerControlledLifetimeManager());
            ...
            ViewModelLocator.SetDefaultViewTypeToViewModelTypeResolver((viewType) => {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "FormValidation.UILogic.ViewModels.{0}ViewModel, FormValidation.UILogic, Version=1.0.0.0, Culture=neutral", viewType.Name);
