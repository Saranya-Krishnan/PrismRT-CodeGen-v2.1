...
{
    public sealed partial class StateListPage : VisualStateAwarePage
    {
        ...
        protected override void SaveState(Dictionary<string, object> pageState) {
            ...
            var scrollViewer = VisualTreeUtilities.GetVisualChild<ScrollViewer>(itemsListView);
            if (scrollViewer != null) {
                pageState["stateItemsSvVerticalOffset"] = scrollViewer.VerticalOffset;
            }
        }
        ...
        protected override void LoadState(object navigationParameter, Dictionary<string, object> pageState) {
            ...
            if (pageState.ContainsKey("stateItemsSvVerticalOffset")) {
                _scrollViewerVerticalOffset = double.Parse(pageState["stateItemsSvVerticalOffset"].ToString(), CultureInfo.InvariantCulture.NumberFormat);
            }
        }
    }
}
