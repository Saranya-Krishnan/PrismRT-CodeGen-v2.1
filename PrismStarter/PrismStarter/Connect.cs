...
namespace PrismStarter
{
	...
	public class Connect : IDTExtensibility2, IDTCommandTarget
	{
		...
		public void OnConnection(object application, ext_ConnectMode connectMode, object addInInst, ref Array custom)
		{
            ...
            if (IfSolutionPathExists())
            {
                MessageBox.Show(string.Format("SolutionPath exists already.{0}{1}{2}{3}",
                    Environment.NewLine, settingsObject.TargetSolutionPath, Environment.NewLine, "Delete SolutionPath then try again."),
                    "Canceling Run");
                return;
            }
			...
			if(connectMode == ext_ConnectMode.ext_cm_UISetup)
			{
				...
				try
				{
					...
					Command command = commands.AddNamedCommand2(_addInInstance, "PrismStarter", "PrismStarter", "Executes the command for PrismStarter", true, 59, ref contextGUIDS, (int)vsCommandStatus.vsCommandStatusSupported+(int)vsCommandStatus.vsCommandStatusEnabled, (int)vsCommandStyle.vsCommandStylePictAndText, vsCommandControlType.vsCommandControlTypeButton);
        ...
        private void SetupOutputWindow(DTE2 applicationObject)
        {
            ...
            owp = outputWindow.OutputWindowPanes.Add("PrismStarter");
        ...
        {
            return Directory.Exists(settingsObject.TargetSolutionPath);
        }
		...
		public void QueryStatus(string commandName, vsCommandStatusTextWanted neededText, ref vsCommandStatus status, ref object commandText)
		{
			...
			{
				if(commandName == "PrismStarter.Connect.PrismStarter")
				{
